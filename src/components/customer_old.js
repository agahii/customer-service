...
const CustomerRegistration = () => {
  ...
  const [submitting, setSubmitting] = useState(false);
   // This will hold the selected employee IDs
  ...
  const handleEdit = (record) => {
      ...
      customerProjectInp: record.customerProject?.map((project) => ({
        ...
        //   customerAgents: project.customerAgent?.map((agent,i) => ({
            //     fK_Employee_ID: agent.fK_Employee_ID,
            //   })) || [],
            //   gccSupervisors: project.gccSupervisor?.map((sup,i) => ({
                //     fK_Employee_ID: sup.fK_Employee_ID,
                //   })) || [],
                //   customerSupervisors: project.customerSupervisor?.map((sup,i) => ({
                    //     fK_Employee_ID: sup.fK_Employee_ID,
                    //   })) || [],
